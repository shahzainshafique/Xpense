...
import GithubIcon from "../src/assets/img/copyright/github.svg";
...
export const copyright = {
  ...
  copyText: "Made with ❤ by Shahzain Shafique",
  social: [
    { icon: FacebookIcon, href: "/" },
    { icon: GithubIcon, href: "https://github.com/shahzainshafique" },
    {
      icon: LinkedinIcon,
      href: "https://www.linkedin.com/in/shahzainshafique/",
    },
  ],
};
